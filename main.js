...
// Função para verificar se o nome já está no localStorage
function verificarNomeNoLocalStorage() {
    const nomeArmazenado = localStorage.getItem('nomeUsuario'); // Verifica se o nome já está armazenado
    
    if (nomeArmazenado) {
        // Se o nome existir no localStorage, redireciona para a página principal
